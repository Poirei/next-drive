      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/[0.08] px-3 py-1 md:mb-12"
          >
        ...
        >
          <p className="mx-auto mb-8 max-w-xl px-4 text-base font-light leading-relaxed tracking-wide text-white/40 sm:text-lg md:text-xl">
            Simplified file sharing and collaboration, empowering teams with
            secure access and seamless organization.
          </p>
        </motion.div>
        <motion.div
          custom={2}
          ...
          <Link href={"/dashboard"} className="absolute">
            <div>
              <GlowEffect
                ...
                scale={0.9}
              />
              <button className="relative inline-flex items-center gap-1 rounded-full bg-zinc-950 px-5 py-2 text-sm text-zinc-50 outline outline-1 outline-[#fff2f21f]">
